...
void main() {
   ...
   FragColor.rgb = CrtsFilter(v_texCoord.xy * outputSize.xy,
   u_imageResolution.xy / outputSize.xy,
   u_imageResolution.xy * vec2(0.5,0.5),
   1.0 / u_imageResolution.xy,
   1.0 / outputSize.xy,
   2.0 / outputSize.xy,
   u_imageResolution.y,
   warp_factor,
